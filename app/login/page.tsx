        ...
        >
          ...
          <div className="space-y-3 mb-6">
            <motion.button
              ...
              disabled={loading}
              className="w-full px-4 py-3 bg-white rounded-xl text-black font-medium hover:bg-white/90 transition flex items-center justify-center gap-3 disabled:opacity-50"
